        ...
        renderedExample={(
          <>
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Primary emphasized button clicked', duration: 3500 }), [addBanner])}
            >
              Primary Color
            </Button>
            <Button
              appearance="solid"
              color="secondary"
              onClick={useCallback(() => addBanner({ message: 'Secondary emphasized button clicked', duration: 3500 }), [addBanner])}
            >
              Secondary Color
            </Button>
            <Button
              appearance="solid"
              color="accent"
              onClick={useCallback(() => addBanner({ message: 'Accent emphasized button clicked', duration: 3500 }), [addBanner])}
            >
              Accent Color
            </Button>
            <Button
              appearance="solid"
              onClick={useCallback(() => addBanner({ message: 'Default emphasized button clicked', duration: 3500 }), [addBanner])}
            >
              No Color
            </Button>
          </>
      ...
      <StaticExample
        ...
        renderedExample={(
          <>
            <Button
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Primary unemphasized  button clicked', duration: 3500 }), [addBanner])}
            >
              Primary Color
            </Button>
            <Button
              appearance="outlined"
              color="secondary"
              onClick={useCallback(() => addBanner({ message: 'Secondary unemphasized  button clicked', duration: 3500 }), [addBanner])}
            >
              Secondary Color
            </Button>
            <Button
              appearance="outlined"
              color="accent"
              onClick={useCallback(() => addBanner({ message: 'Accent unemphasized  button clicked', duration: 3500 }), [addBanner])}
            >
              Accent Color
            </Button>
            <Button
              appearance="outlined"
              onClick={useCallback(() => addBanner({ message: 'Unemphasized button clicked', duration: 3500 }), [addBanner])}
            >
              No Color
            </Button>
          </>
        ...
        renderedExample={(
          <>
            <Button
              appearance="outlined"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Cancel button clicked', duration: 3500 }), [addBanner])}
            >
              Cancel
            </Button>
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Okay button clicked', duration: 3500 }), [addBanner])}
            >
              Okay
            </Button>
          </>
        ...
        renderedExample={(
          <>
            <Button
              ...
              onClick={useCallback(() => addBanner({ message: '`Left Icon` button clicked', duration: 3500 }), [addBanner])}
            >
              Button
            </Button>
            <Button
              ...
              onClick={useCallback(() => addBanner({ message: '`See More` button clicked', duration: 3500 }), [addBanner])}
            >
              See More
            </Button>
          </>
        ...
        renderedExample={(
          <>
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Small button clicked', duration: 3500 }), [addBanner])}
            ...
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Mdium button clicked', duration: 3500 }), [addBanner])}
            ...
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: 'Large button clicked', duration: 3500 }), [addBanner])}
            ...
            <Button
              appearance="solid"
              color="primary"
              onClick={useCallback(() => addBanner({ message: '`large1x` button clicked', duration: 3500 }), [addBanner])}
      ...
      <StaticExample
        ...
        renderedExample={(
          <Button
            appearance="solid"
            color="primary"
            onClick={useCallback(() => addBanner({ message: 'Medium button clicked', duration: 3500 }), [addBanner])}
            size={formElementSizesEnum.MEDIUM}
            isBusy
          >
            Submit Now
