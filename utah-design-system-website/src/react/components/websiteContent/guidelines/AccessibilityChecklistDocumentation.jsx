      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>Links are easily distinguished from other content by visual cues, such as an underline <strong>and</strong> a different text color.</li>
            <li>A link's hover state is indicated by the cursor changing to a hand pointer <strong>and</strong> a visual effect, such as an underline and a background color change.</li>
