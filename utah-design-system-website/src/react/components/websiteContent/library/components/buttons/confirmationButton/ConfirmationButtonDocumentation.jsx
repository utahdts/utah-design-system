...
import {
  ...
  InitialChildren, Tab, TabGroup, TabList, TabPanel, TabPanels,
  useBanner
...
import { ConfirmationButtonCssClassesDocumentation } from './ConfirmationButtonCssClassesDocumentation';
import { ConfirmationButtonPropsDocumentation } from './ConfirmationButtonPropsDocumentation';
  ...
  return (
    <div className="documentation-content">
      ...
      <ul className="mb-spacing">
        <li>
          <strong>To prevent users from making mistakes.</strong> By prompting users to confirm their actions, uncertainty about the action they have
          taken, or are about
          to take, can be reduced. Additionally, confirmation prompts can help prevent users from making mistakes.
        </li>
        <li>
          <strong>Highlighting irreversible actions.</strong> If a user is about to perform an irreversible action, such as permanently deleting an
          item without the
        ...
        <li>
          <strong>When an action is used infrequently.</strong> When it comes to infrequent actions that users may not remember how to perform, a
          confirmation
      ...
      <ul className="mb-spacing">
        ...
        <li>
          ...
          action, especially
          if the user requires more information about the action that is about to take place. For example: &quot;This will permanently delete this
      ...
      <ul className="mb-spacing">
        <li><strong>Confirmation buttons are for actions.</strong> Use a confirmation button to confirm the user&apos;s selected action. They should
          never be used for purely navigation purposes.
        </li>
        <li><strong>For everything else on buttons.</strong> Please refer to our documentation on <Link to={pageUrls.button}>buttons</Link> for
          guidance on sizing, types (primary, icon, etc.) and accessibility.
        </li>
      </ul>
      ...
      <ul className="mb-spacing">
        <li>When you have a confirmation button that contains an icon that adds additional information, the icon should have non-empty alt text (or
          aria-label for SVG).
        </li>
        <li>In order for a screen reader to detect the change from the initial state to the confirmation state you should
          use <code>aria-live=&quot;polite&quot;</code> region or <code>role=&quot;alert&quot;</code> on the button.
        </li>
      </ul>

      <h2 id="section-settings-props">Settings and Props</h2>
      <div className="documentation-content--small-text">
        <TabGroup defaultValue="confirmation-button-props-css">
          <TabList>
            <Tab id="confirmation-button-props-css">CSS</Tab>
            <Tab id="confirmation-button-props-react">React</Tab>
          </TabList>
          <TabPanels>
            <TabPanel tabId="confirmation-button-props-css">
              <ConfirmationButtonCssClassesDocumentation />
            </TabPanel>

            <TabPanel tabId="confirmation-button-props-react">
              <ConfirmationButtonPropsDocumentation />
            </TabPanel>
          </TabPanels>
        </TabGroup>
      </div>
