...
export const pageUrls = {
  ...
  browserCompatibility: /** @type {PageUrl} */ ('/guidelinesStandards/browserCompatibilityMobileFirst'),
  ...
  colorGuidelines: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/color'),
  ...
  dataPrivacy: /** @type {PageUrl} */ ('/guidelinesStandards/dataPrivacyForms/dataPrivacy'),
  dataVisualizations: /** @type {PageUrl} */ ('/guidelinesStandards/dataPrivacyForms/dataVisualizations'),
  dateInput: /** @type {PageUrl} */ ('/library/components/forms/dateInput'),
  demoPage: /** @type {PageUrl} */ ('/resources/demoPage'),
  depthElevationShadows: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/depthElevationShadows'),
  digitalCredentials: /** @type {PageUrl} */ ('/guidelinesStandards/dataPrivacyForms/verifiableDigitalCredentials'),
  ...
  formGuidelines: /** @type {PageUrl} */ ('/guidelinesStandards/dataPrivacyForms/formGeneralGuidance'),
  ...
  images: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/images'),
  infoBox: /** @type {PageUrl} */ ('/library/components/forms/infoBox'),
  layout: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/layoutFlexGridSystem'),
  ...
  opacity: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/opacity'),
  ...
  shape: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/shapeRoundedCorners'),
  ...
  spacing: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/spacing'),
  ...
  textInputSearch: /** @type {PageUrl} */ ('/library/components/forms/textInput#search-input'),
  ...
  typography: /** @type {PageUrl} */ ('/guidelinesStandards/designGuidelines/typography'),
  utahFooter: /** @type {PageUrl} */ ('/library/utahFooter'),
  utahHeader: /** @type {PageUrl} */ ('/library/utahHeader'),
  validation: /** @type {PageUrl} */ ('/guidelinesStandards/dataPrivacyForms/formValidation'),
