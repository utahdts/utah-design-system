  ...
  return (
    <div className="documentation-content">
      ...
      <div className="documentation-content--small-text">
        <TabGroup defaultValue="file-input-props-css">
          <TabList>
            <Tab id="file-input-props-css">CSS</Tab>
            <Tab id="file-input-props-react">React</Tab>
          </TabList>
          <TabPanels>
            <TabPanel tabId="file-input-props-css">
              <FileInputCssClassesDocumentation />
            </TabPanel>
            <TabPanel tabId="file-input-props-react">
