  ...
  return (
    <div className="documentation-content">
      ...
      <ul className="mb-spacing">
        ...
        <li><strong>Page layout:</strong> Don&apos;t use tables in place of a css grid. </li>
      ...
      <ul className="mb-spacing">
        <li><strong>Add an aria-live region to the page when enabling row sorting:</strong> An <code>aria-live</code> region immediately following the <code>&lt;table&gt;</code> element automatically announces when the sort state changes for visitors using screen readers.</li>
        <li><strong>Don&apos;t add aria-label attributes to sortable column headers:</strong> Enabling row sorting automatically adds <code>aria-label</code> attributes to the sortable column headers and their toggle sort buttons via JavaScript. These labels are updated to reflect each column&apos;s current sort state (ascending, descending, or unsorted) whenever sort changes.</li>
        <li><strong>Simple tables can have up to two rows of headers:</strong> Each header cell should have <code>scope=&quot;col&quot;</code> or <code>scope=&quot;row&quot;</code>.</li>
