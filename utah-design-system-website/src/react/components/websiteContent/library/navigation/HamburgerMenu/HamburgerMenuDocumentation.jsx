...
function HamburgerMenuDocumentation() {
  return (
    <div className="documentation-content">
      ...
      <ul className="mb-spacing">
        <li><strong>Desktop.</strong> If you have the space to do so, consider using a <Link to={pageUrls.mainMenu}>main menu</Link> first.</li>
      ...
      <ul className="mb-spacing">
        ...
        <li><strong>Open and closed.</strong> The button should convey to the user its state (open or closed). Typically, the hamburger icon (three lines) represents a collapsed menu, while an &quot;X&quot; represents an open menu.</li>
      </ul>
      ...
      <ul className="mb-spacing">
        ...
        <li>The icon button&apos;s boundary must maintain a <code>3:1</code> contrast ratio or better.</li>
