...
export function CarouselDocumentation() {
  return (
    <div className="documentation-content">
      ...
      <StaticExample
        title="Carousel"
        renderedExample={<LightBox image={carouselScreenshot} alt="Carousel" className="flex-4up-gap" />}
        quickTips={(
          <ul>
            <li>A carousel is composed of a collection of slides.</li>
            <li>One slide is shown at a time.</li>
            <li>Each slide can include text, images, buttons, or links.</li>
            <li>Controls are present: two buttons allowing the user to go to the next or previous slide.</li>
            <li>Optionally, a list of controls letting the user select a specific slide can be used.</li>
          </ul>
        )}
      />
      ...
      <ul className="mb-spacing">
        <li>
          <strong>User experience.</strong> Generally, the user experience is not great because part of the content is hidden from the user. It requires user interaction to reveal all of the contents in the carousel. Typically users don&apos;t have the patience to wait for a carousel to slide.
        </li>
        <li>
          <strong>Mobile experience.</strong> A good user experience on a mobile device is difficult to achieve with a carousel. Thoughtfully consider how a carousel will appear on a user&apos;s phone or mobile device.
        </li>
        <li>
          <strong>Accessibility.</strong> Generally, carousels have some accessibility issues; keep that in mind when implementing them. If you are trying to grab a user&apos;s attention with some new and/or important content, try using <Link to={pageUrls.card}>cards</Link> or put your content in hierarchical order using an ordered <Link to={pageUrls.lists}>list</Link> instead.
        </li>
      </ul>
      ...
      <ul className="mb-spacing">
        <li>
          ...
          <ul>
            ...
            <li>Additionally, a list of controls letting the user select a specific slide can be used. <br /> For example: a set of circle icons at the bottom of the carousel.</li>
      ...
      <ul className="mb-spacing">
        <li>
          The carousel container should include <code>role=&quot;group&quot;</code> and <code>aria-roledescription=&quot;carousel&quot;</code>. If the carousel has a title associated with it, refer to it by using <code>aria-labelledby</code>; otherwise, use <code>aria-label</code>.
        </li>
        <li>The controls should be native <code>&lt;button&gt;</code> elements.</li>
        <li>
          Make sure the controls include appropriate <code>aria-label</code> attributes. <br /> For example: &quot;Start rotation&quot;, &quot;Pause rotation&quot; or &quot;Next slide&quot;.
        </li>
        ...
        <li>In the case no label is available, refer to each slide by their number. <br /> For example: &quot;Slide 2 of 10.&quot;</li>
        <li>
