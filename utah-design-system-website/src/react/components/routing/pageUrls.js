const pageUrls = {
  ...
  iconBar: '/library/components/buttons/iconBar',
  ...
  skipLink: '/library/components/basic/skipLink',
  ...
  statusIndicator: '/library/components/widgetsIndicators/statusIndicator',
