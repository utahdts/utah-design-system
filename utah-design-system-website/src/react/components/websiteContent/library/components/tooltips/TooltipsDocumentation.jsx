  ...
  return (
    <div className="documentation-content">
      ...
      <ul className="mb-spacing">
        ...
        <li><strong>Critical Information</strong>: To communicate critical information, including errors in forms or other interaction feedback. Consider using <Link to={pageUrls.modals}>Modals</Link> or <Link to={pageUrls.notifications}>Notifications</Link>.</li>
        <li><strong>Avoid Links and Buttons</strong>: As tooltips only surface from a hover, never include links or buttons in the copy. If your tooltip requires either of these, consider putting your content in a <Link to={pageUrls.popups}>Popup</Link>.</li>
        <li><strong>Keep it Brief</strong>: Good tooltips contain concise and helpful information. Keep it short (we recommend no more than 5 words max). If you need more space, consider using a <Link to={pageUrls.popups}>Popup</Link>.</li>
      </ul>
      ...
      <ul className="mb-spacing">
        ...
        <li>Tooltips have slightly different guidelines to Popups and Modals. For more information, see <Link to={pageUrls.popups}>Popup</Link> and <Link to={pageUrls.modals}>Modals</Link> guidelines.</li>
      ...
      <ul className="mb-spacing">
        ...
        <li>Tooltip trigger element should have an <code>aria-describedby</code> attribute which references to the <code>id</code> of the associated tooltip.</li>
