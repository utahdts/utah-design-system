  ...
  return (
    <div className="documentation-content">
      ...
      <div className="documentation-content--small-text">
        <TabGroup defaultValue="checkbox-props-css">
          <TabList>
            <Tab id="checkbox-props-css">CSS</Tab>
            <Tab id="checkbox-props-react">React</Tab>
          </TabList>
          <TabPanels>
            <TabPanel tabId="checkbox-props-css">
              <CheckboxCssClassesDocumentation />
            </TabPanel>
            <TabPanel tabId="checkbox-props-react">
