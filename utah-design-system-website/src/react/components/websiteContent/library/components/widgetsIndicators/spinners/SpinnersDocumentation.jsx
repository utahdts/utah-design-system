  ...
  return (
    <div className="documentation-content">
      ...
      <StaticExample
        ...
        quickTips={(
          <ul>
            <li><strong>Determinate</strong> indicators display the approximate progress of an action.</li>
          </ul>
        )}
      />
      ...
      <StaticExample
        ...
        quickTips={(
          <ul>
            <li>
              <strong>Spinners in Buttons.</strong> Use spinners within <Link to={pageUrls.button}>buttons</Link> to indicate an action is currently processing
              or taking place. You may also swap the text out of the spinner element and utilize button text as needed. For example: <code>Submit</code> → <code>Processing</code>.
            </li>
          </ul>
        )}
      />
      ...
      <ul className="mb-spacing">
        ...
        <li>
          ...
          importing, it&apos;s better to use <Link to={pageUrls.progressBars}>progress bars</Link> and/or <Link to={pageUrls.textIndicators}>text indicators</Link> that
      ...
      <ul className="mb-spacing">
        <li>
          <strong>Creating the perception of speed.</strong> Loading patterns leverage motion to give the feeling of speed and, when used correctly,
          have been proven to make wait times more bearable by shifting focus to the loading indicator rather than the wait time.
        </li>
        <li>
          ...
          elements while the loading indicator is visible, it is recommended to use an overlay, even if the on-page content is already visible behind the loading indicator.
        </li>
        <li>
      ...
      <ul className="mb-spacing">
        ...
        <li>
          ...
          five seconds, and non-essential motion such as loading dots can be turned off by users.
        </li>
        ...
        <li>Always include <code>aria-valuetext=&quot;XXX&quot;</code>, where XXX is a textual presentation of the loader, i.e., &quot;Please wait, this data table is loading…&quot;.</li>
        <li>
