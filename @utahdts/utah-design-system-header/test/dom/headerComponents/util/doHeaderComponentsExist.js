...
export function expectHeaderComponentsExistSanityCheck() {
  ...
  expect(domConstants.VERTICAL_MENU).toBe('vertical-menu');
  expect(domConstants.VERTICAL_MENU__BUTTON_TITLE).toBe('vertical-menu__button-title');
  expect(domConstants.VERTICAL_MENU__CHEVRON).toBe('vertical-menu__chevron');
  expect(domConstants.VERTICAL_MENU__DIVIDER).toBe('vertical-menu__divider');
  expect(domConstants.VERTICAL_MENU__LINK_TEXT).toBe('vertical-menu__link-text');
  expect(domConstants.VERTICAL_MENU__LINK_TITLE).toBe('vertical-menu__link-title');
  expect(domConstants.VERTICAL_MENU__PLAIN_TITLE).toBe('vertical-menu__plain-title');
  expect(domConstants.VERTICAL_MENU__TITLE).toBe('vertical-menu__title');
  expect(domConstants.VERTICAL_MENU_WRAPPER__WRAPPER).toBe('vertical-menu__wrapper');
  expect(domConstants.VERTICAL_MENU_WRAPPER__WRAPPER_TITLE).toBe('vertical-menu__wrapper-title');
